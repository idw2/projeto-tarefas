...
<div class="row-fluid">
    ...
    <div class="span4 well">
        ...
        <p>
            ...
            <span class="label label-important">tarde</span>
            <?php endif; ?>
        </p>
        <?php } ?>
        <p >
            ...
            <?php } ?>
            <strong>Histórico (<?php echo anchor('task/history/'.$project_id.'/'.$task_id, 'details', 'id="task-history-details"'); ?>):</strong>
...
<form class="form-horizontal" method="post" action="<?php echo base_url('task/comment'); ?>">
    ...
    <div class="row-fluid">
        <div class="span12">
            <textarea name="comment" id="comment" rows="5" class="input-xxlarge" placeholder="Novo Comentário"><?php echo set_value('comment'); ?></textarea>
            <br/>
