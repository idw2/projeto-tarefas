    ...
    <body>
        ...
        <div id="removeModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="removeModalLabel" aria-hidden="true">
          <div class="modal-header">
            ...
            <h3 id="myModalLabel">Você tem certeza?</h3>
          </div>
          <div class="modal-body">
              <div class="alert alert-block">
                  <h4>Aviso!</h4>
                  Esta ação não pode ser desfeita. Tem certeza de que deseja continuar?</p>
              </div>
          </div>
          <div class="modal-footer">
            <a href="{url}" class="btn btn-warning">Sim, eu sei o que estou fazendo.</a>
