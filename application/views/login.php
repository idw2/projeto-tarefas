...
<!--            <form class="form-signin" action="<?php echo base_url('install/database'); ?>" method="post">
        ...
        <?php } else { ?>
            <div class="alert">O Painel de tarefas já foi instalado!</div>
        <?php } ?>
    <?php } else { ?>
        <form class="form-signin" method="post"
            ...
            <?php if(isset($error) && $error) : ?>
                ...
                <div class="alert alert-error">
                    Isso não está certo! Verifique as informações e tente novamente.
                    <!--
            ...
            <?php if(isset($already_installed) && !$already_installed) : ?>
                <button class="btn btn-primary" type="submit" name="install">Instalar</button>
            <?php else : ?>
