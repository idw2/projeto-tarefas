<div id="task-comment-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="removeModalLabel" aria-hidden="true">
    <div class="modal-header">
        ...
        <h3 id="myModalLabel">Mover Tarefa</h3>
    </div>
    <div class="modal-body">
        <form class="form-horizontal" id="task-comment-modal-form" method="post" action="<?php echo base_url("task/ajax_comment/$project_id/$task_id/$status"); ?>">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <textarea name="comment" id="comment" rows="5" class="input-xxlarge" placeholder="Seu comentário (opicional)"></textarea>
                </div>
            </div>
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-success" id="task-comment-submit">Continuar</button>
